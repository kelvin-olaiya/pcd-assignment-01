...
\* BEGIN TRANSLATION (chksum(pcal) = "7ab9c257" /\ chksum(tla) = "6aba91c2")
...
master == set_latch \/ distr_w1 \/ distr_w2 \/ finished
...
Spec == /\ Init /\ [][Next]_vars
        /\ WF_vars(Next)
        /\ /\ WF_vars(master)
           /\ SF_vars(set_latch) /\ SF_vars(distr_w1) /\ SF_vars(distr_w2)
